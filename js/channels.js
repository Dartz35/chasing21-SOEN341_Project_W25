...
async function deletechannel(channelId) {
  ...
  try {
    ...
    // Remove channel from each member's list
    ...
    await set(channelRef, null); // Deletes the channel
...
async function addMember(channelId) {
  ...
  try {
    ...
    channelMembers.push(newMemberEmail); // Add new member
    await set(channelMembersRef, channelMembers); // Update Firebase
